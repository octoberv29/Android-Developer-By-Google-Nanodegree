...
public class NotificationUtils {
    ...
    private static final String WATER_REMINDER_NOTIFICATION_CHANNEL_ID = "1";
    private static final int WATER_REMINDER_PENDING_INTENT_ID = 3417;
    private static final int WATER_REMINDER_NOTIFICATION_ID = 50;
    ...
    // COMPLETED (1) Create a helper method called contentIntent with a single parameter for a Context.
    //  It should return a PendingIntent.
    // This method will create the pending intent which will trigger when the notification is pressed.
    ...
    public static Bitmap largeIcon(Context context) {
        ...
        Bitmap largerIcon = BitmapFactory.decodeResource(res, R.drawable.ic_local_drink_black_24px);
        return largerIcon;
    }
