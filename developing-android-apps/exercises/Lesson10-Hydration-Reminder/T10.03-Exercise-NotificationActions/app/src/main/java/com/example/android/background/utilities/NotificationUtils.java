...
public class NotificationUtils {
    ...
    private static final int ACTION_DRINK_PENDING_INTENT = 101;
    ...
    public static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        NotificationCompat.Action drinkReminderAction =
                new NotificationCompat.Action(R.drawable.ic_drink_notification, "I did it!", pendingIntent);
