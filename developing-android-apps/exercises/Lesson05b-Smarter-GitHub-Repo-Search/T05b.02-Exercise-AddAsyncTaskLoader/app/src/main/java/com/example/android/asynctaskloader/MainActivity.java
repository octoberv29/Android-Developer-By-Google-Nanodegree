...
//        new GithubQueryTask().execute(githubSearchUrl);
        ...
        Bundle queryBundle = new Bundle(); // it's taken by Loaders as an argument
        ...
        LoaderManager githubSearchLoader = getLoaderManager();
        if (githubSearchLoader != null) {
            githubSearchLoader.initLoader(GITHUB_SEARCH_LOADER, queryBundle, this);
        } else {
            githubSearchLoader.restartLoader(GITHUB_SEARCH_LOADER, queryBundle, this);
        }
    }
    ...
    public Loader<String> onCreateLoader(int i, final Bundle bundle) {
        ...
        // COPLETED (5) Override onStartLoading
